...
const App = async () => {
    ...
    return (
        <div className="team_section bg-[#f5f5f5] pt-[60px] pb-[100px]">
            <div className="w-[90%] max-w-[1140px] mx-auto">
                            ...
                            before:h-[1px] before:bg-[#999]">{sectionContent.title}</h2>
                {
                    sectionContent.list.map((_item: listItem, _index: number) => {
                        return (
                            <div className={clsx(
                                "item flex flex-col justify-between pb-[50px] border-b border-dashed border-[#dcdcdc]",
                                {
                                ...
                                <div className="image_box w-[100%] pb-[30px]">
                                            ...
                                            _item.content.map((listItem: contentItem, listIndex: number) => {
                                                return (
                                                    <div className="list flex pb-[20px]" key={listIndex}>
                                                        <h4 className="title text-[15px] text-[#121212] min-w-[70px] mr-[40px]">{listItem.title}</h4>
