...
const App = async () => {
    ...
    return (
        <div className="process_section relative w-[80%] bg-[#fff] mt-[-100px] mx-auto py-[100px]">
            <div className="container max-w-[1140px] flex items-center mx-auto ">
                <div className="title_box w-[50%] pb-[30px]">
                ...
                <div className="content_box w-[50%]">
