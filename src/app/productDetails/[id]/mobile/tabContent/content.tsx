                            ...
                            if (props.detailContent) {
                                return (
                                    props.detailContent.map((item: detailContentItem, index: number) => {
                                        return (
                                            <li className={clsx(
                                                "text-[18px] pr-[20px] pb-[20px] cursor-pointer hover:text-[#231916]",
                                                {
                            ...
                            if (content) {
                                return (
                                    content.map((item: contentItem, index: number) => {
                                        return (
                                            <div className={clsx(
                                                "flex w-[100%] px-[10px] pb-[20px] flex-col border-b-none",
                                                {
                                                ...
                                                <div className="w-[100%]">
                                                    <div className="pt-[10px] pb-[10px] text-justify">{item.text}</div>
                                                </div>
                                            </div>
                                        );
                                    })
